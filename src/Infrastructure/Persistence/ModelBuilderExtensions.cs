    ...
    namespace CleanArchitecture.Infrastructure.Persistence
{
        public static class ModelBuilderExtensions
        {
            ...
            public static void RenameIdentityTableName(this ModelBuilder modelBuilder)
            {


                modelBuilder.Entity<ApplicationUser>(entity => { entity.ToTable(name: "AccUsers"); });

                modelBuilder.Entity<IdentityRole>(entity => { entity.ToTable(name: "AccRoles"); });

                modelBuilder.Entity<IdentityUserClaim<long>>(entity => { entity.ToTable("AccUserClaims"); });

              //  modelBuilder.Entity<IdentityUserLogin<long>>(entity => { entity.ToTable("AccUsersLogins"); });

               modelBuilder.Entity<IdentityRoleClaim<long>>(entity => { entity.ToTable("AccRoleClaims"); });

               modelBuilder.Entity<IdentityUserRole<long>>(entity => { entity.ToTable("AccUserRoles"); });

                modelBuilder.Entity<IdentityUserToken<long>>(entity => { entity.ToTable("AccUserTokens"); });
